<div class="dashboard-container" style="display: flex; flex-direction: column; min-height: 100%; flex: 1;">
    ...
    <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:1.75rem; flex-wrap:wrap; gap:1rem; flex-shrink: 0;">
        ...
        <div style="display:flex; align-items:center; gap:1rem;">
            <a href="{{ route('manager.products.create') }}" class="btn-primary" style="padding: 0.4rem 0.8rem; font-size: 0.7rem; background-color: #d4af37; color: white; border: none; border-radius: 6px; cursor: pointer; text-decoration: none;">
                <i class="fa-solid fa-plus"></i> Add Product
            </a>
            <a href="{{ route('manager.stock-in.create') }}" class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.7rem; background-color: #4a2c00; color: white; border: none; border-radius: 6px; cursor: pointer; text-decoration: none;">
                <i class="fa-solid fa-download"></i> Stock In
            </a>
            <a href="{{ route('reports.sales.create') }}" class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.7rem; background-color: #4a2c00; color: white; border: none; border-radius: 6px; cursor: pointer; text-decoration: none;">
